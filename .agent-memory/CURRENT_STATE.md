...
- **PR #26 (Current)**: Enhanced Navbar with `v1.0 · Free` status badge, pill-hover navigation links, `⭐ Star 1.4k` GitHub counter button, and made all floating background stickers fully interactive with hover physics, tooltips, and smooth-scroll anchors.
