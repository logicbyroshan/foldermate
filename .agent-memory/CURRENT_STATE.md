...
- **PR #25 (Current)**: Enriched landing page background with a subtle neo-brutalist dotted grid matrix, floating animated feature badges (Inbox Watcher with pulse, 2-Phase Atomic Move, SHA-256 Verified, Supported Formats), rotating sparkle stars (✦, ★), and soft warm ambient aura glows.
