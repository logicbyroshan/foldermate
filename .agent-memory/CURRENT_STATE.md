...
- **PR #20 (Current)**: Responsive laptop screen scaling (preventing vertical elongation on small screens), 3-task scrollable list in Key Generator with custom scrollbar and scroll hint, enlarged split feature mockup cards with rich metadata and action buttons, and cohesive neo-brutalist dark footer.
